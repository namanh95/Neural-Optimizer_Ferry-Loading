...
ROOT = Path("/mnt/data")
OUT = ROOT / "ngflo_dynamic_commit_v1"
...
sdf.to_csv(OUT/"commit_episode_summary.csv",index=False)
ldf.to_csv(OUT/"commit_epoch_log.csv",index=False)
...
comp.to_csv(OUT/"commit_controller_comparison.csv",index=False)
...
agg.to_csv(OUT/"commit_aggregate_summary.csv",index=False)
